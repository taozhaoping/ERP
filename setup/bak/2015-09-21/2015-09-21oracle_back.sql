...
-- Created by john on 2015/9/21, 11:04:43 --
--------------------------------------------

set define off
spool 2015-09-21oracle_back.log
...
(
  ...
  descr       VARCHAR2(500),
  effdt       VARCHAR2(40),
  eff_status  VARCHAR2(1) default 0
)
tablespace ERP_ORCL
  pctfree 10
  initrans 1
...
prompt
prompt Creating procedure BOM_PURCHASING_DEMAND
prompt ========================================
prompt
create or replace procedure erp.bom_Purchasing_demand(v_order_id number) as
begin
declare
